package org.bitcoins.protocol.rpc
...
import org.bitcoins.protocol.rpc.bitcoincore.blockchain.{BlockchainInfo, ConfirmedUnspentTransactionOutput, MemPoolInfo}
import org.bitcoins.protocol.rpc.bitcoincore.mining.GetMiningInfo
import org.bitcoins.protocol.rpc.bitcoincore.networking.{NetworkInfo, PeerInfo}
import org.bitcoins.protocol.rpc.bitcoincore.wallet.WalletInfo
import spray.json._
